//$Id: ABCProxyTest.java,v 1.4 2004/06/04 01:27:35 steveebersole Exp $
...
public class ABCProxyTest extends TestCase {
	...
	public void testOptionalOneToOneInCollection() throws Exception {
		...
		c2 = (C2) s.get(C2.class, c2.getId());
		assertTrue( c2.getC1s().size()==1 );
		s.delete( c2.getC1s().iterator().next() );
		s.delete(c2); 
		t.commit();
		s.close();
