//$Id: ReadWriteCache.java,v 1.8 2004/06/04 01:27:36 steveebersole Exp $
...
public class ReadWriteCache implements CacheConcurrencyStrategy {
	 ...
	 */
	public synchronized void afterUpdate(Object key, Object value, SoftLock clientLock) throws CacheException {
	...
	public static final class Lock implements Serializable, Lockable, SoftLock {
		 ...
		 */
		public boolean isPuttable(long txTimestamp) {
			return ( mutiplicity==0 && unlockTimestamp < txTimestamp ) || timeout < txTimestamp;
		}
