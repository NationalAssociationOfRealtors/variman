//$Id: SessionFactoryImpl.java,v 1.34 2004/08/02 20:33:28 turin42 Exp $
...
public final class SessionFactoryImpl implements SessionFactory, SessionFactoryImplementor {
	...
	public ClassPersister getPersister(Class theClass) throws MappingException {
		if (theClass.isArray()) throw new MappingException("No persister for array result, likely a broken query");
	...
	public CollectionPersister getCollectionPersister(String role) throws MappingException {
		...
		if (result==null) throw new MappingException( "No persister for collection role: " + role );
		return result;
	}
