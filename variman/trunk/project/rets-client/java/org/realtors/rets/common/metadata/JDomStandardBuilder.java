...
public class JDomStandardBuilder extends MetadataBuilder {
	...
	public static final String ELEMENT_LOOKUP = "LookupType";
	public static final String ELEMENT_LOOKUPTYPE = "Lookup";
	public static final String ELEMENT_VALIDATIONLOOKUP = "ValidationLookupType";
	public static final String ELEMENT_VALIDATIONLOOKUPTYPE = "ValidationLookup";
	...
	static {
		...
		sType2Element.put(MetadataType.FOREIGN_KEYS, ELEMENT_FOREIGNKEY);
	...
	private void processLookup(MResource parent, Element container) {
		List elements = container.getChildren(ELEMENT_LOOKUP);
		for (int i = 0; i < elements.size(); i++) {
			Element element = (Element) elements.get(i);
	...
	private void processLookupType(MLookup parent, Element container) {
		List elements = container.getChildren(ELEMENT_LOOKUPTYPE);
		for (int i = 0; i < elements.size(); i++) {
			Element element = (Element) elements.get(i);
