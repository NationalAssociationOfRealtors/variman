...
public class LoginResponse extends KeyValueResponse {
	...
	private RetsDateTime metadataTimestamp;
	private RetsDateTime minMetadataTimestamp;
	...
	protected void handleKeyValue(String key, String value) throws RetsException {
		...
		if (matchKey(key, BROKER_KEY)) {
			...
			try
			{
				this.metadataTimestamp = new RetsDateTime(value);
			} 
			...
			try
			{
				this.minMetadataTimestamp = new RetsDateTime(value);
			}
			catch (ParseException e)
			{
				this.minMetadataTimestamp = null;
			}
	...
	public RetsDateTime getMetadataTimestamp()
	{
		return this.metadataTimestamp;
	}
	
	public RetsDateTime getMinMetadataTimestamp()
	{
