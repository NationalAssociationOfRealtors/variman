...
import org.realtors.rets.server.webapp.cct.SearchHandler;

public class BasicSearch extends BaseCertificationTest
{
    ...
    public void start()
    {
        ...
        SearchHandler search = handlers.getSearchHandler();
        search.setGetInvokeCount(InvokeCount.ONE);
        search.addStandardHeaders();
        search.addStandardCookies(SESSION_ID);
